<template>
    <layout>
        ...
        <fieldset>
            <div class="mt-6 space-y-6" style="width: 200px">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-x-3">
                        <input id="todo" name="type" type="radio" v-model="type" value="todo"
                               class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600"/>
                        <label for="todo" class="block text-sm font-medium leading-6 text-gray-900">To Do</label>
                    </div>
                    <div class="flex items-center gap-x-3">
                        <input id="repair" name="type" type="radio" v-model="type" value="repair"
                               class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600"/>
                        <label for="repair" class="block text-sm font-medium leading-6 text-gray-900">Repair</label>
                    </div>
                    <div class="flex items-center gap-x-3">
                        <input id="part" name="type" type="radio" v-model="type" value="part"
                               class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600"/>
