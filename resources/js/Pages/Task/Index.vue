                        ...
                        <div class="inline-block min-w-full py-2 align-middle">
                            <table class="min-w-full divide-y divide-gray-300">
                                ...
                                <tr v-for="item in tasks" :key="item.task_id">
                                    <td v-if="item.status === 'approved'" class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6 lg:pl-8">
                                        {{ item.first_name }} {{ item.last_name }}</td>
                                    <td v-if="item.status === 'approved'" class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ item.description }}</td>
                                    <td v-if="item.status === 'approved'" class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6 lg:pr-8">
                    ...
                    <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                        <div class="inline-block min-w-full py-2 align-middle">
                            <table class="min-w-full divide-y divide-gray-300">
                                ...
                                <tbody class="divide-y divide-gray-200 bg-white">
                                <tr v-for="item in tasks" :key="item.task_id">
                                    <td v-if="item.status === 'pickedUp'" class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6 lg:pl-8">
                                        {{ item.first_name }} {{ item.last_name }}</td>
