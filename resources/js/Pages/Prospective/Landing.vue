        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:mx-0">
                <div class="flex justify-between">
                    ...
                    <h2 @click="logout()" v-if="$page.props.user"
                        class="font-bold tracking-tight text-white whitespace-nowrap text-base font-medium">
                        Logout
                    </h2>
                </div>
    ...
    <div class="bg-white py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:text-center">
                <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Schedule Your
                    Consultation</p>
                <p class="mt-6 text-lg leading-8 text-gray-600">Select the date below. Then select one of the available
                    times
    ...
    <div class="bg-white py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <p class="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600">Choose an affordable plan
                that’s
                packed with the best features for engaging your audience, creating customer loyalty, and driving
                sales.</p>
            ...
            <div
                    ...
                    <div
                        ...
                        <figure class="relative isolate">
                            ...
                            <figcaption class="mt-6 text-sm leading-6 text-gray-300"><strong
                                class="font-semibold text-white">Judith
                ...
                <div>
                    <div class="text-base leading-7 text-gray-700 lg:max-w-lg">
                        ...
                        <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">On a mission to
                            empower remote
                            teams</h1>
                        <div class="max-w-xl">
